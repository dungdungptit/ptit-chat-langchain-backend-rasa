...
def search(question):
    ...
    for i in range(1, 100):
        list_topic_response = requests.get(
            f"http://192.168.10.198:1338/api/feedbacks?populate=*&pagination[pageSize]=100&pagination[page]={i}",
        )
    ...
    list_topic_response = requests.get(
        "http://192.168.10.198:1338/api/intents?populate=*&pagination[pageSize]=100",
